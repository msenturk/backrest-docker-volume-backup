...
const (
	...
	Backrest_DiscoverDocker_FullMethodName       = "/v1.Backrest/DiscoverDocker"
	Backrest_CreateDockerPlans_FullMethodName    = "/v1.Backrest/CreateDockerPlans"
	Backrest_UpdateSnapshotTags_FullMethodName   = "/v1.Backrest/UpdateSnapshotTags"
...
type BackrestClient interface {
	...
	DiscoverDocker(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*DiscoverDockerResponse, error)
	// CreateDockerPlans bulk-creates plans based on discovered Docker volumes.
	CreateDockerPlans(ctx context.Context, in *CreateDockerPlansRequest, opts ...grpc.CallOption) (*Config, error)
	// UpdateSnapshotTags updates the tags for a list of snapshots.
	UpdateSnapshotTags(ctx context.Context, in *UpdateSnapshotTagsRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *backrestClient) DiscoverDocker(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*DiscoverDockerResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DiscoverDockerResponse)
	err := c.cc.Invoke(ctx, Backrest_DiscoverDocker_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *backrestClient) CreateDockerPlans(ctx context.Context, in *CreateDockerPlansRequest, opts ...grpc.CallOption) (*Config, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Config)
	err := c.cc.Invoke(ctx, Backrest_CreateDockerPlans_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *backrestClient) UpdateSnapshotTags(ctx context.Context, in *UpdateSnapshotTagsRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Backrest_UpdateSnapshotTags_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *backrestClient) DiffSnapshots(ctx context.Context, in *DiffSnapshotsRequest, opts ...grpc.CallOption) (*DiffSnapshotsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type BackrestServer interface {
	...
	// DiscoverDocker returns a list of Docker containers and their volumes.
	DiscoverDocker(context.Context, *emptypb.Empty) (*DiscoverDockerResponse, error)
	// CreateDockerPlans bulk-creates plans based on discovered Docker volumes.
	CreateDockerPlans(context.Context, *CreateDockerPlansRequest) (*Config, error)
	// UpdateSnapshotTags updates the tags for a list of snapshots.
	UpdateSnapshotTags(context.Context, *UpdateSnapshotTagsRequest) (*emptypb.Empty, error)
	// DiffSnapshots compares two snapshots and returns the differences.
...
func (UnimplementedBackrestServer) DiscoverDocker(context.Context, *emptypb.Empty) (*DiscoverDockerResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DiscoverDocker not implemented")
}
func (UnimplementedBackrestServer) CreateDockerPlans(context.Context, *CreateDockerPlansRequest) (*Config, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateDockerPlans not implemented")
}
func (UnimplementedBackrestServer) UpdateSnapshotTags(context.Context, *UpdateSnapshotTagsRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateSnapshotTags not implemented")
}
func (UnimplementedBackrestServer) DiffSnapshots(context.Context, *DiffSnapshotsRequest) (*DiffSnapshotsResponse, error) {
...
func _Backrest_DiscoverDocker_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackrestServer).DiscoverDocker(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Backrest_DiscoverDocker_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackrestServer).DiscoverDocker(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}

func _Backrest_CreateDockerPlans_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateDockerPlansRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackrestServer).CreateDockerPlans(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Backrest_CreateDockerPlans_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackrestServer).CreateDockerPlans(ctx, req.(*CreateDockerPlansRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Backrest_UpdateSnapshotTags_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateSnapshotTagsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackrestServer).UpdateSnapshotTags(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Backrest_UpdateSnapshotTags_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackrestServer).UpdateSnapshotTags(ctx, req.(*UpdateSnapshotTagsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Backrest_DiffSnapshots_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackrestServer).DiffSnapshots(ctx, req.(*DiffSnapshotsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Backrest_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DiscoverDocker",
			Handler:    _Backrest_DiscoverDocker_Handler,
		},
		{
			MethodName: "CreateDockerPlans",
			Handler:    _Backrest_CreateDockerPlans_Handler,
		},
		{
			MethodName: "UpdateSnapshotTags",
			Handler:    _Backrest_UpdateSnapshotTags_Handler,
		},
		{
