...
func file_v1_crypto_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_v1_crypto_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_v1_crypto_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_v1_crypto_proto_msgTypes[2].Exporter = func(v any, i int) any {
