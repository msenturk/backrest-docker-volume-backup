...
var file_v1_operations_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x22, 0x95, 0x01, 0x0a, 0x0f, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x28, 0x08, 0x52, 0x06, 0x64, 0x72, 0x79, 0x52, 0x75, 0x6e, 0x22, 0x60, 0x0a, 0x16, 0x4f, 0x70,
...
func file_v1_operations_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_v1_operations_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_v1_operations_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_v1_operations_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_v1_operations_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_v1_operations_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_v1_operations_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_v1_operations_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_v1_operations_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_v1_operations_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_v1_operations_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_v1_operations_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_v1_operations_proto_msgTypes[11].Exporter = func(v any, i int) any {
